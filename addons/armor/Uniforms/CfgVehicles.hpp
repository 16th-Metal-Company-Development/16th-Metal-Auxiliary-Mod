...
class MET_Uniform_Trooper_Cerberus_Base : MET_Uniform_Trooper_Base
{
	scope = 1;
	displayName = "[16th] Cerberus";
	uniformClass = "MET_Uniform_Trooper_Cerberus";
	hiddenselectionsTextures[] =
	{
		"z\MET\addons\Armor_Rewrite\Uniforms\Textures\Custom\MET_Cerberus_Uniform1_CO.paa",
		"z\MET\addons\Armor_Rewrite\Uniforms\Textures\Custom\MET_Cerberus_Uniform2_CO.paa"
	};
	linkedItems[] =
	{
