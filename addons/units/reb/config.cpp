...
class cfgVehicles
{
	...
	class Rebel_Man_Base : B_Soldier_base_F	// Define of a new class, which parameters are inherited from B_Soldier_base_F, with exception of those defined below.
	{
		...
		identityTypes[] = { "Male03PER","WhiteHead_01","G_NATO_default" };		// Identity Types are explained in the Headgear section of this guide.
		displayName = "Rebel_Man_Base"; // The name of the soldier, which is displayed in the editor.
		...
		model = "\ls\core\addons\characters\uniforms\pathfinder\ls_uniform_pathfinder.p3d";		// The path to the uniform model this character uses.
		uniformClass = "ls_uniform_pathfinder";							// This links this soldier to a particular uniform. For the details, see below.
	...
	class MET_REB_Rifleman_E5 : Rebel_Man_Base
	{
		scope = 2;
		scopeCurator = 2;
		scopeArsenal = 2;
	...
	class MET_REB_Rifleman_DC15S : Rebel_Man_Base
	{
		scope = 2;
		scopeCurator = 2;
		scopeArsenal = 2;
	...
	class MET_REB_Autorifleman_DC15L : Rebel_Man_Base
	{
		scope = 2;
		scopeCurator = 2;
		scopeArsenal = 2;
	...
	class MET_REB_Autorifleman_E5C : Rebel_Man_Base
	{
		scope = 2;
		scopeCurator = 2;
		scopeArsenal = 2;
	...
	class MET_REB_Marksman_DC15X : Rebel_Man_Base
	{
		scope = 2;
		scopeCurator = 2;
		scopeArsenal = 2;
	...
	class MET_REB_Marksman_E5S : Rebel_Man_Base
	{
		scope = 2;
		scopeCurator = 2;
		scopeArsenal = 2;
	...
	class MET_REB_Grenadier : Rebel_Man_Base
	{
		scope = 2;
		scopeCurator = 2;
		scopeArsenal = 2;
	...
	class MET_REB_Light_Antitank : Rebel_Man_Base
	{
		scope = 2;
		scopeCurator = 2;
		scopeArsenal = 2;
		...
		respawnMagazines[] = { "MET_Weapons_Mags_Thermal_Detonator","MET_Weapons_Mags_Thermal_Detonator","MET_Smoke_White","MET_Smoke_White","ACE_painkillers","3AS_60Rnd_EM30_mag","3AS_60Rnd_EM30_mag","3AS_60Rnd_EM30_mag","3AS_60Rnd_EM30_mag","3AS_60Rnd_EM30_mag","3AS_60Rnd_EM30_mag","3AS_60Rnd_EM30_mag","3AS_60Rnd_EM30_mag","3AS_60Rnd_EM30_mag","3AS_60Rnd_EM30_mag","DBA_90mm_IK40_FRAG_x1_mag","DBA_90mm_IK40_FRAG_x1_mag","DBA_90mm_IK40_FRAG_x1_mag","DBA_90mm_IK40_FRAG_x1_mag" };
		linkedItems[] = { "ItemMap","ItemCompass","ItemWatch","ls_radios_hush98_aurebesh","ItemMicroDAGR","ls_nvg_goggles","212th_RangeFinder_Unmarked","ls_orsfHelmet_trooper","V_Chestrig_blk_noHydrator","3AS_G_AT_4_F","ls_nvg_goggles" };
		respawnLinkedItems[] = { "ItemMap","ItemCompass","ItemWatch","ls_radios_hush98_aurebesh","ItemMicroDAGR","ls_nvg_goggles","212th_RangeFinder_Unmarked","ls_orsfHelmet_trooper","V_Chestrig_blk_noHydrator","3AS_G_AT_4_F","ls_nvg_goggles" };
		backpack = "MET_Light_AntiTank_RPS6_pack";
	};

	class MET_REB_Crewman : Rebel_Man_Base
	{
		scope = 2;
		scopeCurator = 2;
		scopeArsenal = 2;
