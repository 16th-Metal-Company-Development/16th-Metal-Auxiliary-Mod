...
class CfgWeapons
{
	...
	class Metal_Mass_Driver_Cannon: cannon_railgun
	{
		scope=1;
		displayName="[16th] Mass Driver Cannon";
		cursor="EmptyCursor";
		cursorAim="cannon";
...
class CfgVehicles
{
    ...
    /*class MET_ATTE_MkII: APC_Wheeled_01_base_F
    {
        scope=2;
        scopeCurator = 2;
        displayName="[16th] AT-TE Mk II";
	...
	class MET_ATTE_MkII: APC_Wheeled_01_base_F
	{
		...
		class TextureSources
		{
			...
			class Lightning: Republic
			{
				displayName="Lightning Squad";
				textures[]=
				{
