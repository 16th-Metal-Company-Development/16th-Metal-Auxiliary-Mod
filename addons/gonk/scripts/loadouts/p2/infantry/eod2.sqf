...
// Backpack // 
player addBackpack "backpack_16th_eod";
for "_i" from 1 to 2 do {player addItemToBackpack "MET_Weapons_Mags_Ctype";};
for "_i" from 1 to 10 do {player addItemToBackpack "3AS_DetPack";};
