...
// Weapons //
player addWeapon "MET_DC15L_F";
player addPrimaryWeaponItem "MET_DC15L_mag";
...
for "_i" from 1 to 3 do {player addItemToVest "MET_DC15L_mag";};

// Backpack // 
player addBackpack "backpack_16th";
for "_i" from 1 to 7 do {player addItemToBackpack "MET_DC15L_mag";};
