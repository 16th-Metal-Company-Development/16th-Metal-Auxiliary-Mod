...
// Weapons //
player addWeapon "MET_Valken38X_F";
player addPrimaryWeaponItem "MET_Valken_mag";
player addPrimaryWeaponItem "MET_Optic_VK38X";
...
// Vest // 
for "_i" from 1 to 6 do {player addItemToVest "MET_Valken_mag";};

// Backpack // 
player addBackpack "beltpack_16th";
for "_i" from 1 to 10 do {player addItemToBackpack "MET_Valken_mag";};
