...
// Weapons //
player addWeapon "MET_Z6";
player addPrimaryWeaponItem "MET_blaster_battery";
...
for "_i" from 1 to 30 do {player addItemToUniform "LFP_item_bacta_bandage";};
...
// Vest // 
player addVest "vest_16_backpack_rack_ammo_bearer";
player addItemToVest "MET_blaster_battery";
player addItemToVest "MET_blaster_battery";
player addItemToVest "MET_blaster_battery_green";

// Backpack // 
player addBackpack "backpack_16th";
for "_i" from 1 to 12 do {player addItemToBackpack "MET_blaster_battery";};
