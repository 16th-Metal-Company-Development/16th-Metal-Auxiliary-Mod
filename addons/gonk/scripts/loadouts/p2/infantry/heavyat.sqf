...
player addWeapon "plx_16th";
player addWeaponItem "metal_at_mag";
...
// Vest // 
player addVest "vest_16_backpack_rack_at";
for "_i" from 1 to 9 do {player addItemToVest "MET_DC15A_mag";};

// Backpack // 
player addBackpack "backpack_16th_heavy";
for "_i" from 1 to 5 do {player addItemToUniform "metal_at_mag";};
for "_i" from 1 to 5 do {player addItemToUniform "metal_ap_mag";};
