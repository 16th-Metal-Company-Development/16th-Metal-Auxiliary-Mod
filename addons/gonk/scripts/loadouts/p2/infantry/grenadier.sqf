...
// Weapons //
player addWeapon "MET_DC15A_ugl_plastic";
player addPrimaryWeaponItem "MET_DC15A_mag";
player addPrimaryWeaponItem "MET_HE_Grenade";
...
// Backpack // 
player addBackpack "backpack_16th";
for "_i" from 1 to 9 do {player addItemToUniform "MET_HE_Grenade";};
for "_i" from 1 to 5 do {player addItemToUniform "MET_AT_Grenade";};
player addItemToUniform "MET_ILLUM_Grenade";
for "_i" from 1 to 2 do {player addItemToUniform "MET_ILLUM_IR_Grenade";};
for "_i" from 1 to 2 do {player addItemToUniform "MET_ILLUM_G_Grenade";};
for "_i" from 1 to 2 do {player addItemToUniform "MET_ILLUM_R_Grenade";};
for "_i" from 1 to 5 do {player addItemToUniform "MET_SMKW_Grenade";};
for "_i" from 1 to 2 do {player addItemToUniform "MET_SMKB_Grenade";};
for "_i" from 1 to 2 do {player addItemToUniform "MET_SMKR_Grenade";};
player addItemToUniform "MET_SMKY_Grenade";
