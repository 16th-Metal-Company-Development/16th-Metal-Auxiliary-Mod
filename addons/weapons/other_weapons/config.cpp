...
class CfgWeapons
{
	...
	class met_FHR1:SC_Rifle_Bastard
	{
		author="16th Aux Team";
		scope=2;
		scopeArsenal=1;
...
class CfgMagazines
{
	...
	class MET_SBB3_mag: 30Rnd_65x39_caseless_mag
	{
		JLTS_hasElectronics=1;
		JLTS_hasEMPProtection=1;
		author="MrClock";
...
class CfgAmmo
{
	...
	class MET_slug_orange: 3AS_PlasmaBase
	{
		model="\Indecisive_Armoury_Ammos\Data\Tracers\IDA_Blasterbolt_Yellow.p3d";
	...
	class MET_pellet_subminition_orange: MET_slug_orange
	{
		deflecting=2;
	};
	class M_Titan_AP;
